...
import { GalleryImageDirective } from '../gallery-image/o-gallery-image.directive';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GalleryActionComponent, GalleryArrowsComponent, GalleryImageDirective],
  inputs: [
    'images',
    'links',
    'labels',
